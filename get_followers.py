...
options.add_extension("/Users/karansingh/Downloads/instagram_sjmc/extension.crx")
...
username.clear()
username.send_keys("dav.college.confessions")
password.clear()
password.send_keys("DAVCONcollege22@")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/karansingh/Downloads/{}_followers.csv /Users/karansingh/Downloads/instagram_sjmc/accounts'.format(account))
        except:
